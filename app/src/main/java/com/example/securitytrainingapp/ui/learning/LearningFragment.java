...
public class LearningFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        articleOne[2] = "Creating and remembering a secure password is crucial when using today’s technology.  This article will serve to help you create a strong, secure, and memorable password.  " +
                "\n\n" +
                "First, avoid the key mistake of making your password related to an aspect of your life.  Avoid passwords that contain your pet’s name, your university, year you graduated, your favorite number, your child’s name, and your favorite sport’s team.  Passwords containing this information are easy to crack because almost all this information can be found on your social media page.  Programs exist that will easily crack passwords given this information.  " +
                "\n\n" +
                "Second, go beyond the usual password security requirements.  Most websites have you create a password that contains at least one uppercase character, one number, one lowercase character, one special character, and be at least eight characters in length.  The problem with this is that people usually follow the pattern of the first character being uppercase, followed by lowercase characters, and then ending the password with the number and special character.  Avoid this pattern by using several uppercase characters and special characters throughout the password.  For example, the password “b!rCh92tAb!e” is much more secure than “Birchtable92!”  " +
                "\n\n" +
                "Next, to be as secure as possible, it is now recommended that instead of using a password, a passphrase should be used.  This passphrase should be longer in length than a password and have little to no meaning to you.  An example passphrase is “TheBoatLeft74!ShoreAt!Dawn”  " +
                "\n\n" +
                "Finally, it is important to never reuse a password.  While this is easier said than done, this step is crucial because it prevents your secure information from multiple sites being accessed because one site got hacked.\n";
        ...
        articleThree[2] = "The internet is a vast expanse of knowledge and useful resources; thus it makes sense that it also includes scammers and viruses trying to steal your money and data.  This article will provide you with tips and strategies to keep you safe while using the internet.  " +
                "\n\n" +
                "First, it is important to have an anti-virus or anti-malware program on your computer.  Please read the article “Choosing an Anti-virus Program” before continuing with this reading.  Second, it is important to take into account whose Wi-Fi network you are using, and what actions you are performing.  If you are on a public network like a coffee shop, avoid performing actions like paying off your credit card bill or logging into your bank account.  Hackers target public Wi-Fi networks because their security is usually subpar, allowing them to easily infiltrate its users’ traffic and steal their information (like passwords).  If it is necessary for you to perform actions like those on a public Wi-Fi network, you should use a Virtual Private Network (VPN).  VPNs provide a secure tunnel for your internet traffic, making it harder for hackers to view what you are doing on your computer.\n";
